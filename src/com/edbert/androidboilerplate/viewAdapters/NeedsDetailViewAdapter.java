package com.edbert.androidboilerplate.viewAdapters;

import com.edbert.androidboilerplate.DatabaseHelpers.NeedsCommentsDatabaseHelper;
...
public class NeedsDetailViewAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		Cursor commentCursor = context
				.getContentResolver()
				.query(BoilerPlateContentProvider
